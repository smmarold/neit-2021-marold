...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <span class="navbar-brand">Patient Records</span>
    </div>
    <ul class="nav navbar-nav">
        <li <?php if(basename($_SERVER['PHP_SELF']) == 'view.php'): ?>class="active"<?php endif; ?>><a href="view.php">View Patients</a></li>
        <li <?php if(basename($_SERVER['PHP_SELF']) == 'patientEdit.php'): ?>class="active"<?php endif; ?>><a href="patientEdit.php?action=Add">Add Patient</a></li>
    </ul>
